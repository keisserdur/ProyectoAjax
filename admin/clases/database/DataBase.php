...
class DataBase {
    ...
    private static function createCondition(array $parametros, $operador = 'and') {
        $condicion = '';
        foreach ($parametros as $nombreParametro => $valorParametro) {
            if(is_array($valorParametro)){
                $condicion .= $nombreParametro . " in (";
                foreach($valorParametro as $unidad){
                     $condicion .= "$unidad, ";
                }
    ...
    function deleteParameters($tabla, array $parametros = array(), $operador = 'and') {
        $condicion = self::createCondition($parametros, $operador);
